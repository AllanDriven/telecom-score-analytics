...
/****** Object:  StoredProcedure [dbo].[SP_TAB_TELECOM_SCORE_CARTEIRAS]    Script Date: 04/03/2026 13:26:01 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    SET @SQL = N'
        ...
        SELECT
            ...
            SUM(CASE WHEN S.SCORE = 1.5 THEN 1 ELSE 0 END) AS SCORE_1_5,
            ...
            SUM(CASE WHEN S.SCORE = 1.5 THEN A.valor ELSE 0 END) AS CUSTO_SCORE_1_5,
